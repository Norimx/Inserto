    ...
    <div id="post-body-content">
      <div class="postbox">
        <div class="inside">
          ...
          <?php settings_fields( 'inserto-scripts' ); 
...
$(document).on("keyup keydown", function(e){
    ...
    if(e.ctrlKey && e.which == 83){	
      ...
      $('.submit-area input.button').click();
      return false;
    }
  });		
  ...
  setTimeout(_=>{
		if($('.error').length>0){
			$('.error').each(function(){ 
			if($(this).text().includes('WP All Import'))
				$(this).remove();	});
		} 	
	},600);
});
